...
The khotan schema component provides Drizzle ORM table definitions for plugs, syncs, and runs — the data layer backing the Hub UI and flow components. Scaffolded via `npx khotan add schema`, the file is self-contained and user-owned.
